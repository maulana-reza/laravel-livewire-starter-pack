<div>
    @if(!@$multiple)
        {!! Form::select($name,$option,'',['wire:model'=>$name,'class' => 'w-full rounded-md shadow-sm border-gray-300 focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50']) !!}
    @else
        <div>
            <style>
                [x-cloak] {
                            ...
                            <div class="my-2 p-1 flex border border-gray-200 bg-white rounded svelte-1l8159u">
                                <div class="flex flex-auto flex-wrap">
                                    <template x-for="(option,index) in selected" :key="options[option].value">
                                        <div
                                            class="flex justify-center items-center font-medium pl-2 bg-white rounded-full text-teal-700 bg-teal-100 border border-teal-300 ">
	...
	"/>
                        ...
                        <div class="w-full px-4">
                            <div x-show.transition.origin.top="isOpen()"
                                ...
                                <div class="flex flex-col w-full max-h-80 overflow-auto">
